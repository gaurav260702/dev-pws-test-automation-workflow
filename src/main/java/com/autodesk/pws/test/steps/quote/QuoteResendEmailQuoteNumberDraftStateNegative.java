...
public class QuoteResendEmailQuoteNumberDraftStateNegative extends PwsServiceBase
{
    ...
    {
		super.setResourcePath("/v1/quotes/sendemail?quoteNumber=$QUOTE_NUMBER$");
    }
