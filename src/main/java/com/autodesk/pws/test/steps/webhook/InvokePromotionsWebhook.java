...
public class InvokePromotionsWebhook extends PwsServiceBase
{
    @Override
...
//        System.out.println("Invoking event with id:" + eventId);
        ...
        PutEventsRequest putEventsRequest = PutEventsRequest.builder()
                .entries(
                        PutEventsRequestEntry.builder()
                                .source("urn:adsk.dpe.dbp:moniker:CPRMCTLG-S-UW2")
                                .detailType("adsk.o2pcoop:promotions.update.PROMOTION_CHANGED")
                                .detail(json) // Your payload here
                                .eventBusName("pws-promotions-upd-subscriber")
                                .build()
                )
                .build();
        ...
        System.out.println("Promotions Event published successfully");

        //Step 3: Reading cloudwatch logs
        System.out.println("Starting to reading Promotions Cloudwatch logs every 1min ");
        String logGroupName = "/aws/lambda/pws-promotions-upd-notify-async-"+env;
