...
public class QuoteStatusAfterFinalize extends PwsServiceBase
{
	...
	QuoteStatusAfterFinalize()
	{
		LoopTillExpectedStatus = false;
	}

	public QuoteStatusAfterFinalize(boolean useLoopTillExpectedStatus)
	{
    ...
    public void preparation()
    {
		...
		ExpectedEndStateStatus = "UNDER-REVIEW";
