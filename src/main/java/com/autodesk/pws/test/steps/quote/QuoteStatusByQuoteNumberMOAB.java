...
public class QuoteStatusByQuoteNumberMOAB extends QuoteStatus
{
  public QuoteStatusByQuoteNumberMOAB(boolean useLoopTillExpectedStatus)
  {
...
@Override
  public void preparation() 
  {
    ...
    {
    	this.ExpectedEndStateStatus = "UNDER-REVIEW";
    }
