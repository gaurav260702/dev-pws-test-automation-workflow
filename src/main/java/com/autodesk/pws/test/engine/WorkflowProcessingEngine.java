...
public class WorkflowProcessingEngine
{
    ...
    public com.autodesk.pws.test.engine.DataPool DataPool; // { get; private set; }
    public final String LineMark =  System.getProperty("line.separator");

    public void Execute(List<StepBase> workflowToExecute, com.autodesk.pws.test.engine.DataPool dataPool, Logger logger) throws Exception
    {
        ...
        //  Prep a container for looping throug..
        StepBase step = null;
